...
<?php $component->withAttributes([]); ?>
    ...
    <section class="text-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <a href="<?php echo e(url('/redirect')); ?>"> <button type="submit" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center  bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                go back
            </button></a>
        </div>
      </section>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\phplec\laravel\summittion2prototyp\resources\views/customer-feedback.blade.php ENDPATH**/ ?>